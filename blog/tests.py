...
class TestModel(TestCase):
    ...
    def test_tag(self):
        ...
        self.assertEqual(post_000.tags.count(), 2)  # post는 여러개의 tag를 가질수 있다
...
class TestView(TestCase):
    ...
    def test_post_list_with_post(self):
        ...
        self.assertIn('정치/사회', main_div.text)  ####첫번째 포스트에는 '정치/사회' 있어야
    ...
    def test_post_create(self):
        ...
        self.client.login(username='smith', password='nopass')
        response = self.client.get('/blog/create/')
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_comment(self):
        ...
        self.assertIn('power over whelming', soup.body.text)
